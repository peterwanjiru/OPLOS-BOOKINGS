...
<html lang="en">
<head>
<title>OPLOS Booking.com-Your ultimate booking patner</title>
<meta charset="utf-8">
				...
				<div class="row">
					<div class="col main_nav_col d-flex flex-row align-items-center justify-content-start">
						<div class="logo_container">
							<div class="logo"><a href="#"><img src="images/logo.png" alt="">OPLOS Booking.com</a></div>
						</div>
						<div class="main_nav_container ml-auto">
							<ul class="main_nav_list">
								<li class="main_nav_item"><a href="#">home</a></li>
								<li class="main_nav_item"><a href="book">about us</a></li>
				...
				<div class="col fill_height">
					...
					<div class="search_tabs_container">
						<div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
							<div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/suitcase.png" alt=""><span>Book Flexible Meeting and conference space Search and book a space now</span></div>
							...
							<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/suitcase.png" alt="">Conferences</div>
					...
					<div class="search_panel active">
						<form action="#" id="search_form_1" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
							<div class="search_item">
								<div>City</div>
								  ...
								  <div class="autocomplete" style="width:300px;">
								    ...
								    <input type="text" class="destination search_input" name="myCountry" placeholder = "Meeting City e.g Nairobi" required="required">
								  </div>
							...
							<div class="search_item">
								<div>check in</div>
								<input class="date form-control" style="width: 150px;" type="text" placeholder="check-in date">  
							...
							<div class="search_item">
								<div>check out</div>
								    <input class="date form-control" style="width: 150px;" type="text" placeholder="check-out date">  
								    <script type="text/javascript">  
								        $('.date').datepicker({  
								           format: 'mm-dd-yyyy'  
								         });  
							...
							<div class="search_item">
								<div>timing</div>
								<select name="children" id="children_1" class="dropdown_item_select search_input" style="width: 150px;">
			...
			<div class="row intro_items">
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						...
						<div class="intro_item_background" style="background-image:url(images/4.jpg)"></div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							<!--<div class="intro_date">May 25th - June 01st</div>-->
							<div class="button intro_button"><div class="button_bcg"></div><a href="product">Get a Quote<span></span><span></span><span></span></a></div>
							<div class="intro_center text-center">
								<h1>Manyatta</h1>
								<div class="intro_price">From Ksh 7500</div>
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						...
						<div class="intro_item_background" style="background-image:url(images/hiltonext.jpg)"></div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							<!--<div class="intro_date">May 25th - June 01st</div>-->
							<div class="button intro_button"><div class="button_bcg"></div><a href="product">Qet a Quote<span></span><span></span><span></span></a></div>
							<div class="intro_center text-center">
								<h1>Hilton Hotel</h1>
								<div class="intro_price">From Ksh 2550</div>
				...
				<div class="col-lg-4 intro_col">
					<div class="intro_item">
						...
						<div class="intro_item_background" style="background-image:url(images/GoldetTulip21.jpg)"></div>
						<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
							<!--<div class="intro_date">May 25th - June 01st</div>-->
							<div class="button intro_button"><div class="button_bcg"></div><a href="product">Get a Quote<span></span><span></span><span></span></a></div>
							<div class="intro_center text-center">
								<h1>Silver Springs</h1>
								<div class="intro_price">From Ksh 1850</div>
								<div class="rating rating_4">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
		...
		<div class="living_middle">
   	  <div class="container">
   	    ...
   	    <div class="col-md-4 wow fadeInLeft" data-wow-delay="0.4s">
   	    	<div class="living_box"><a href="product">
				...
				<h3><a href="product">Safari Park Hotel</a></h3>
				<p>Spacious elagant conference rooms. </p>
   	     ...
   	     <div class="col-md-4 wow fadeInLeft" data-wow-delay="0.4s">
   	     	<div class="living_box"><a href="product">
			    <img src="images/l10.jpg" class="img-responsive" alt=""/>
				<span class="sale-box">
				  <span class="sale-label">-22%</span>
			    </span>
				</a>
				<div class="living_desc">
				<h3><a href="product">Best Western Plus Meridian Hotel</a></h3>
				<p>Nairobi, Kenya - Muranga Road, Nairobi City Centre </p>
				<ul><span class="glyphicon glyphicon-star" aria-hidden="true"></span>
				<span class="glyphicon glyphicon-star" aria-hidden="true"></span>
			    <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
			    <span class="glyphicon glyphicon-star" aria-hidden="true"></span>
   	     ...
   	     <div class="col-md-4 wow fadeInLeft" data-wow-delay="0.4s">
				...
				<div class="living_desc">
				<h3><a href="product">Travellers Beach Hotel & Club</a></h3>
				<p>Mombasa, Kenya - Malindi Road, Bamburi Beach </p>
				<a href="product" class="btn3">Book</a>
				<p class="price">Ksh16,000.00</p>
				</div>
			    <table border="1" class="propertyDetails">
                <tbody><tr>
                   <td><img src="images/area.png" alt="" style="margin-right:7px;">2,412m</td>
...
Select dates and number of people, and Search.</div>
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="row">
                    <div><img src="images/zoom.png" alt=""></div>
                    <div class="col-lg-12 col-md-12 how-it-works-icon-container">
                        <div class="hiw2">
				...
				<div class="col-lg-3 footer_column">
					<div class="footer_col">
						<div class="footer_content footer_about">
							...
							<p class="footer_about_text">OPLOS Booking.com is an online platform for conference,meeting, rooms and hotel booking .We always do our best to make sure our clients gets satisfactory services. BookMe is an easy to use platform</p>
						...
						<div class="footer_content footer_blog">
							...
							<div class="footer_blog_item clearfix">
								...
								<div class="footer_blog_content">
									<div class="footer_blog_title"><a href="blog.html">Meeting Rooms</a></div>
							...
							<div class="footer_blog_item clearfix">
								...
								<div class="footer_blog_content">
									<div class="footer_blog_title"><a href="blog.html">Conferences</a></div>
									<!--<div class="footer_blog_date">Nov 29, 2017</div>-->
								</div>
							</div>
							...
							<div class="footer_blog_item clearfix">
								...
								<div class="footer_blog_content">
									<div class="footer_blog_title"><a href="blog.html">Training Rooms</a></div>
									<!--<div class="footer_blog_date">Nov 29, 2017</div>-->
								</div>
							</div>
					...
					<div class="footer_col">
						...
						<div class="footer_content footer_tags">
							<ul class="tags_list clearfix">
								<li><a href="hotels.blade.php">Serena Hotels</a></li>
								<li><a href="hotels.blade.php">PrideInn Paradise</a></li>
								<li><a href="hotels.blade.php">Silver Springs Hotel</a></li>
								<li><a href="hotels.blade.php">FairMount Hotel</a></li>
								<li><a href="hotels.blade.php">Hilton Hotels</a></li>
								<li><a href="hotels.blade.php">Hotel Kempisky</a></li>
								<li><a href="hotels.blade.php">Great Riftvalley Lodge</a></li>
								<li><a href="hotels.blade.php">Maanzoni Lodge</a></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="footer_content footer_contact">
							<ul class="contact_info_list">
								...
								<li class="contact_info_item d-flex flex-row">
									...
									<div class="contact_info_text"><a href="mailto:info@bookme.co.ke?Subject=Hello" target="_top">info@bookme.co.ke</a></div>
								</li>
